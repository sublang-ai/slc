...
// The single TEXT2GEARS-1 prompt establishes no runtime-value placeholders,
...
function snapshotOptions(value: unknown): PlaybookRuntimeOptions {
  ...
  if (
    ...
    throw new TypeError(
      'text2gears playbook runtime accepts no options; received unexpected value',
    );
  }
  return {};
}
...
const createPlaybookRuntime: PlaybookRuntimeFactory<PlaybookRuntimeOptions> =
  createXStatePlaybookRuntime(text2gearsMachine, spec);
