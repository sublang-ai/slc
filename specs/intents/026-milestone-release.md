...
Publish the compiler milestone the demo depends on: the contract-based adoption regime, the adopted Playbook 12.2.0 set with compiled-execution bundles, and the published host-capabilities facade in place of local copies.
