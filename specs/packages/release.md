...
| --- | --- |
| Automatic release checks | Load the emitted entry and drive one Boss turn over fake host ports to a terminal outcome, with the scripted state initializing a repository in the run directory without an agent call [[release-10](#release-10)]. |
