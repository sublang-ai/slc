...
Where a dormant role-bearing schema-3 registry fixture and deterministic live host capabilities are available, when automatic release-readiness checks probe the entry contract without a Boss turn, the gate shall exercise one quiescent consumer lifecycle before production emission is enabled:
