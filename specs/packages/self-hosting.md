...
The Playbook 10 schema-3 definition and artifact set is current under [DR-024](../decisions/024-playbook-10-schema-3-adoption.md) and its completed activation in [DR-027](../decisions/027-complete-playbook-10-activation.md), with schema-1 support retained only for historical artifacts; later releases are adopted routinely under [DR-028](../decisions/028-contract-based-adoption-without-recompilation.md), retaining each bundle by verified equivalence.
