...
Cligent (`@sublang/cligent`), the SDK through which `slc` reaches coding agents.

## Interpreted runs

### PHEXEC-16

Verifies: [PHEXEC-8](../dev/phase-execution.md#phexec-8), [PHEXEC-10](../dev/phase-execution.md#phexec-10), [PHEXEC-11](../dev/phase-execution.md#phexec-11), [PHEXEC-12](../dev/phase-execution.md#phexec-12)
...
Verifies: [PHEXEC-4](../dev/phase-execution.md#phexec-4), [PHEXEC-9](../dev/phase-execution.md#phexec-9)
...
Verifies: [PHEXEC-3](../dev/phase-execution.md#phexec-3), [PHEXEC-5](../dev/phase-execution.md#phexec-5), [PHEXEC-6](../dev/phase-execution.md#phexec-6)
...
When the slc command interprets a phase, the agent prompt shall embed the phase or link definition verbatim and the fixed agent contract — definition authoritative, write only the target, no commits, preserve verbatim, self-verify, and permission to run definition-called tools and read cited content — with no phase-specific rules added by slc.
