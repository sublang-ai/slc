...
This scenario exercises a seeded compile or link turn only. [PHEXEC-29](../dev/phase-execution.md#phexec-29)'s update-capable compile — the Boss request carrying `sublang.slc.update-request.v1` — has no compiled transport and so is verified by nothing while scoped-update selection stays withheld.
