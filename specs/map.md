...
| test | [self-hosting.md](test/self-hosting.md) | Acceptance: reserved-name and `playbook`-pipeline resolution and `playbook` linking — via a fixture and via Playbook's provided definitions — at DR-001 locations |
