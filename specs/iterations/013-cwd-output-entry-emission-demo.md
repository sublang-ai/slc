...
- [x] Entry sources with a foreign extension compile as raw inputs through auto-scheduled normalization (`PIPE-6`, `PIPE-34`, `PIPE-39`, [[compiler-7](../packages/compiler.md#compiler-7)]).
- [x] Discovered passes run by default with `--no-optimize` as the escape (`PIPE-32`, `PIPE-35`, `PIPE-37`, [[compiler-8](../packages/compiler.md#compiler-8)]).
