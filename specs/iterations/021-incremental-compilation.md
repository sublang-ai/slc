...
6. [ ] **Journal lineage promotion.** Add recoverable multi-path promotion, commit-marker ordering, interruption recovery, and fault-injection tests on the overlay primitive; defer canonical-run recovery acceptance to later tasks.
