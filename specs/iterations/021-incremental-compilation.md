...
A post-close review (reviewer: GPT-5.6 Sol) converged on two foundational corrections, consolidated into one hardening commit over the eight-commit rewrite, then completed by three follow-up commits.
