...
- [x] [DR-010](../decisions/010-playbook-runtime-contract-evolution.md), [DR-005](../decisions/005-slc-self-hosting-meta-pipeline.md), `phase-execution`, `VERIFY`, `CI`, and `map.md` record the three exact runtime profiles, provenance-driven fail-closed selection, result mapping, nested-call policy, trace privacy, structured verification, CI choice, and release boundary.
