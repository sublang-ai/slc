...
- [x] [DR-012](../decisions/012-playbook-routing-control-separation.md), `phase-execution`, `verification`, and `map.md` record the result-metadata, exact-text, isolated-call, and presentation contracts.
