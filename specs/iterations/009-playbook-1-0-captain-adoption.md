...
- [x] [DR-011](../decisions/011-playbook-1-0-captain-contract-adoption.md), `phase-execution`, `verification`, `self-hosting`, `CI`, and `map.md` record the immutable boundary and required verification.
