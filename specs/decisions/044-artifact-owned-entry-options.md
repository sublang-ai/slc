...
This entry-output prompt contract and validator are explicit exceptions to the generic execution boundary of [DR-003](003-slc-phase-execution.md), as bounded by [[phase-execution-1](../packages/phase-execution.md#phase-execution-1)].
