...
Phase definitions may additionally declare `## Pin Inputs` for compiled artifact pinning per [DR-007](007-slc-phase-artifact-pinning.md); that section is optional and does not change the ordinary compile-chain format contract.
